...
corr<-as.data.frame(round(cor(cibersort_tumor[,1:22]),3))
write.table(corr,"corr_cibersort_tumor_LIHC.txt",sep = "\t")
library(ggcorrplot)
p.mat<-as.data.frame(round(cor_pmat(cibersort_tumor[,1:22]),3))
write.table(p.mat,"p.mat_cibersort_tumor_LIHC.txt",sep = "\t")
